...
extension GoalQueryFilter on QueryBuilder<Goal, Goal, QFilterCondition> {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> savedAmountEqualTo(
    double value, {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> savedAmountGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> savedAmountLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> savedAmountBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension GoalQuerySortBy on QueryBuilder<Goal, Goal, QSortBy> {
  ...
  QueryBuilder<Goal, Goal, QAfterSortBy> sortBySavedAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAmount', Sort.asc);
    });
  }

  QueryBuilder<Goal, Goal, QAfterSortBy> sortBySavedAmountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GoalQuerySortThenBy on QueryBuilder<Goal, Goal, QSortThenBy> {
  ...
  QueryBuilder<Goal, Goal, QAfterSortBy> thenBySavedAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAmount', Sort.asc);
    });
  }

  QueryBuilder<Goal, Goal, QAfterSortBy> thenBySavedAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAmount', Sort.desc);
    });
  }
...
extension GoalQueryWhereDistinct on QueryBuilder<Goal, Goal, QDistinct> {
  ...
  QueryBuilder<Goal, Goal, QDistinct> distinctBySavedAmount() {
    return QueryBuilder.apply(this, (query) {
...
extension GoalQueryProperty on QueryBuilder<Goal, Goal, QQueryProperty> {
  ...
  QueryBuilder<Goal, double, QQueryOperations> savedAmountProperty() {
    return QueryBuilder.apply(this, (query) {
